  ...
  return (
    <div className="grid gap-4 xl:grid-cols-2">
      {groups.map((group) => {
        ...
        const vehicleTypeLabel = formatVehicleType(group.vehicleType);
              ...
              <div className="space-y-3">
                <div className="grid gap-3 sm:grid-cols-[1fr_1fr]">
                  <div className="overflow-hidden rounded-[1.35rem] border border-white/10 bg-white/5">
                    {group.vehiclePhoto ? (
                      <img src={group.vehiclePhoto} alt={vehicleTypeLabel} className="h-36 w-full object-cover" />
                    ) : (
                ...
                <div className="flex flex-wrap items-start justify-between gap-3">
                  <div>
                    <p className="text-xl font-black text-white">
                      {vehicleTypeLabel} - {group.seatCount} ghế
                    </p>
