    ...
    <form onSubmit={handleSubmit} className="grid gap-3 sm:grid-cols-2">
      ...
      <div className="sm:col-span-2 grid gap-3 sm:grid-cols-2">
        ...
        <div className="overflow-hidden rounded-2xl border border-white/10 bg-white/5">
          {vehiclePreview ? (
            <img src={vehiclePreview} alt="Ảnh xem trước xe" className="h-40 w-full object-cover" />
          ) : (
      ...
      <div className="sm:col-span-2 grid gap-3 sm:grid-cols-2">
        ...
        <div className="overflow-hidden rounded-2xl border border-white/10 bg-white/5">
          {driverPreview ? (
            <img src={driverPreview} alt="Ảnh xem trước tài xế" className="h-40 w-full object-cover" />
          ) : (
      ...
      {uploading ? <p className="sm:col-span-2 text-sm text-slate-400">Đang tải ảnh {formatUploadKind(uploading)}...</p> : null}
      {message ? <p className="sm:col-span-2 text-sm text-slate-300">{message}</p> : null}
    </form>
  );
}
